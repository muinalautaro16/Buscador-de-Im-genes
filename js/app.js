...
function validarFormulario(e) {
  ...
  if (terminoBusqueda === '') {
    mostrarAlerta("agregar un termino");
    return;
  }
...
function buscarImagenes() {
  ...
  const termino = document.querySelector("#termino").value;
    ...
    const key =  '40654191-972e14fb5c968d1249a4cd099';
...
// Generador que a calculat la cantidad de paginas
